          ...
          return (
            <div key={name} className="flex items-center gap-1 flex-1">
              <div className={`flex items-center gap-1.5 px-3 py-2 rounded-xl text-[11px] font-medium w-full justify-center transition-all ${
                ...
                : state === "started" ? "bg-indigo-50 text-indigo-600 border border-indigo-200"
                ...
                {state === "started" && <span className="w-3 h-3 border-[1.5px] border-current border-t-transparent rounded-full spinner" />}
